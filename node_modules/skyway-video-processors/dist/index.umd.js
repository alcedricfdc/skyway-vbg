(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		exports["skyway-video-processors"] = factory();
	else
		root["skyway-video-processors"] = factory();
})(self, () => {
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.ProcessedStream = void 0;
var ProcessedStream = /** @class */ (function () {
    function ProcessedStream(track, type, options) {
        this.isEnabled = true;
        this.track = track;
        this.type = type;
        this.options = options !== null && options !== void 0 ? options : {};
    }
    ProcessedStream.prototype.setEnabled = function (enabled) {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        if (!this.options.stopTrackWhenDisabled) return [3 /*break*/, 7];
                        if (!(this.isEnabled && !enabled)) return [3 /*break*/, 3];
                        this.track.stop();
                        this.isEnabled = enabled;
                        if (!this.options.onStopTrack) return [3 /*break*/, 2];
                        return [4 /*yield*/, this.options.onStopTrack()];
                    case 1:
                        _a.sent();
                        _a.label = 2;
                    case 2: return [2 /*return*/];
                    case 3:
                        if (!(!this.isEnabled && enabled)) return [3 /*break*/, 7];
                    ...
                    case 4:
                        ...
                        this.track = track;
                        this.isEnabled = enabled;
                        if (!this.options.onUpdateTrack) return [3 /*break*/, 6];
                        return [4 /*yield*/, this.options.onUpdateTrack(track)];
                    case 5:
                        _a.sent();
                        _a.label = 6;
    ...
    ProcessedStream.prototype.dispose = function () {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
...
exports.ProcessedStream = ProcessedStream;
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.BlurBackground = void 0;
var selfie_segmentation_1 = __webpack_require__(958);
var processedStream_1 = __webpack_require__(180);
var BlurBackground = /** @class */ (function () {
    function BlurBackground(options) {
        var _this = this;
        ...
        this.selfieSegmentation = new selfie_segmentation_1.SelfieSegmentation({
            locateFile: function (path) { return "https://cdn.jsdelivr.net/npm/@mediapipe/selfie_segmentation/".concat(path); },
        });
        this.selfieSegmentation.setOptions({ modelSelection: 1 });
        this.selfieSegmentation.onResults(function (results) {
            _this.selfieSegmentationOnResults(results);
        });
    }
    BlurBackground.prototype.selfieSegmentationOnResults = function (results) {
        this.processCanvasCtx.save();
        this.processCanvasCtx.clearRect(0, 0, this.processCanvas.width, this.processCanvas.height);
        this.processCanvasCtx.drawImage(results.segmentationMask, 0, 0, this.processCanvas.width, this.processCanvas.height);
        ...
        this.processCanvasCtx.filter = "blur(".concat(this.blurRadius, "px)");
        this.processCanvasCtx.drawImage(results.image, 0, 0, this.processCanvas.width, this.processCanvas.height);
        this.processCanvasCtx.restore();
    };
    BlurBackground.prototype.initialize = function () {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, this.selfieSegmentation.initialize()];
                    case 1:
                        _a.sent();
    ...
    BlurBackground.prototype.getProcessedMediaStreamTrack = function (track) {
        var _this = this;
        ...
        var transformer = new TransformStream({
            transform: function (videoFrame, controller) { return __awaiter(_this, void 0, void 0, function () {
                var newVideoFrame, error_1;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            if (!videoFrame) {
                        ...
                        case 1:
                            ...
                            return [4 /*yield*/, this.selfieSegmentation.send({ image: rawCanvas })];
                        case 2:
                            _a.sent();
                        ...
                        case 3:
                            error_1 = _a.sent();
                            newVideoFrame === null || newVideoFrame === void 0 ? void 0 : newVideoFrame.close();
                            throw error_1;
                        case 4:
                            videoFrame.close();
                            return [7 /*endfinally*/];
    ...
    BlurBackground.prototype.createProcessedStream = function () {
        return __awaiter(this, arguments, void 0, function (options) {
            var stream, track, generator;
            var _this = this;
            var _a, _b, _c;
            ...
            return __generator(this, function (_d) {
                switch (_d.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, navigator.mediaDevices.getUserMedia({
                                audio: false,
                                video: (_a = options.constraints) !== null && _a !== void 0 ? _a : {},
                            })];
                    case 1:
                        stream = _d.sent();
                        track = stream.getVideoTracks()[0];
                        generator = this.getProcessedMediaStreamTrack(track);
                        return [2 /*return*/, new processedStream_1.ProcessedStream(generator, 'blur', {
                                stopTrackWhenDisabled: (_b = options === null || options === void 0 ? void 0 : options.stopTrackWhenDisabled) !== null && _b !== void 0 ? _b : false,
                                onUpdateTrack: function (track) { return __awaiter(_this, void 0, void 0, function () {
                                    var generator_1;
                                    return __generator(this, function (_a) {
                                        switch (_a.label) {
                                            case 0:
                                                this.transformerAbortController = new AbortController();
                                                if (!options.onUpdateTrack) return [3 /*break*/, 2];
                                                generator_1 = this.getProcessedMediaStreamTrack(track);
                                                return [4 /*yield*/, options.onUpdateTrack(generator_1)];
                                            case 1:
                                                _a.sent();
                                                _a.label = 2;
                                            case 2: return [2 /*return*/];
                                ...
                                onStopTrack: function () { return __awaiter(_this, void 0, void 0, function () {
                                    return __generator(this, function (_a) {
                                        track.stop();
                                ...
                                constraints: (_c = options.constraints) !== null && _c !== void 0 ? _c : {},
                            })];
                }
            });
        });
    };
    BlurBackground.prototype.dispose = function () {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        this.transformerAbortController.abort();
                        return [4 /*yield*/, this.selfieSegmentation.close()];
                    case 1:
                        _a.sent();
                        this.isInitialized = false;
                        return [2 /*return*/];
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.VirtualBackground = void 0;
var selfie_segmentation_1 = __webpack_require__(958);
var processedStream_1 = __webpack_require__(180);
var VirtualBackground = /** @class */ (function () {
    function VirtualBackground(options) {
        var _this = this;
        this.isInitialized = false;
        this.transformerAbortController = new AbortController();
        this.selfieSegmentation = new selfie_segmentation_1.SelfieSegmentation({
    ...
    VirtualBackground.prototype.selfieSegmentationOnResults = function (results) {
        this.processCanvasCtx.save();
        this.processCanvasCtx.clearRect(0, 0, this.processCanvas.width, this.processCanvas.height);
        this.processCanvasCtx.drawImage(results.segmentationMask, 0, 0, this.processCanvas.width, this.processCanvas.height);
        this.processCanvasCtx.globalCompositeOperation = 'source-in';
        this.processCanvasCtx.drawImage(results.image, 0, 0, this.processCanvas.width, this.processCanvas.height);
        this.processCanvasCtx.globalCompositeOperation = 'destination-over';
        this.processCanvasCtx.drawImage(this.backgroundImage, 0, 0, this.processCanvas.width, this.processCanvas.height);
        this.processCanvasCtx.restore();
    };
    VirtualBackground.prototype.initialize = function () {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
    ...
    VirtualBackground.prototype.getProcessedMediaStreamTrack = function (track) {
        var _this = this;
        var _a = track.getSettings(), height = _a.height, width = _a.width;
        if (typeof width !== 'number' || typeof height !== 'number') {
            throw new Error('Failed to get video track settings: width or height is not a number');
    ...
    VirtualBackground.prototype.createProcessedStream = function () {
        return __awaiter(this, arguments, void 0, function (options) {
            var stream, track, generator;
            var _this = this;
            var _a, _b, _c;
            ...
            return __generator(this, function (_d) {
                switch (_d.label) {
                    ...
                    case 1:
                        ...
                        track = stream.getVideoTracks()[0];
                        generator = this.getProcessedMediaStreamTrack(track);
                        return [2 /*return*/, new processedStream_1.ProcessedStream(generator, 'virtual-background', {
                                stopTrackWhenDisabled: (_b = options === null || options === void 0 ? void 0 : options.stopTrackWhenDisabled) !== null && _b !== void 0 ? _b : false,
                                onUpdateTrack: function (track) { return __awaiter(_this, void 0, void 0, function () {
                                    var generator_1;
                                    return __generator(this, function (_a) {
    ...
    VirtualBackground.prototype.dispose = function () {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
